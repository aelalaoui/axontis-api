...
🔧 **{{ __('Mode d\'installation') }}** : Installation par technicien Axontis
...
@component('mail::panel')
📦 **{{ __('Mode d\'installation') }}** : Auto-installation (livraison postale)
...
{{ __('Une question ? Contactez notre service client à') }} [{{ config('mail.from.address') }}](mailto:{{ config('mail.from.address') }})
@endcomponent
