...
// Labels des canaux et statuts (réutilisés)
const channelLabels = {
...
<template>
    <Head :title="`Communications - ${client.name || client.full_name}`" />
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div class="flex items-center space-x-4">
                    <Link
                        :href="route('crm.clients.show', client.uuid || client.id)"
                    ...
                    <div>
                        <h1 class="text-2xl font-semibold text-gray-900">
                            📬 Communications de {{ client.name || client.full_name }}
                        </h1>
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    <div v-if="!communications?.data?.length" class="px-6 py-12 text-center text-gray-500">
                        Aucune communication pour ce client
                    </div>
                </div>
